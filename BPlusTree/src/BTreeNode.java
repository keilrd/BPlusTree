class BTreeNode {
    ...
    BTreeNode(int t, boolean leaf) {
        this.t = t;
        this.leaf = leaf;
        this.keys = new long[2 * t]; //updated from 2*t-1 to 2*t
        this.children = new BTreeNode[2 * t + 1]; //updated from 2*t to 2*t+1
        this.n = 0;
        this.next = null;
        this.values = new long[2 * t]; //updated from 2*t-1 to 2*t
    }
}
